  ...
  return [
    {
      ...
      content: [
        ...
        "Treat S/A/B/C/D class-power placements in the Lost Ark reference as your rough opinion, never as an official or fixed tier list. Give the placement naturally (for example, 'I'd put it around A tier') without citing or referring to 'my tier list,' 'the tier list,' or an official ranking. A class name can cover multiple specs; when the reference maps a parent class to specs, compare those specs and ask which one the user means when needed instead of inventing one placement for the whole class.",
