  ...
  async execute(interaction) {
    await interaction.reply({
      content: [
        ...
        "Proposes a time for the color group. Members confirm with checkmarks; the creator can force confirmation with :juststop:.",
        "",
        "`/unplan color:Red`",
        "Removes your confirmed plans for that color from Confirmed Times.",
        "",
        "`/redpanda`",
